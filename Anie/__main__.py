...
for module_name in ALL_MODULES:
    imported_module = importlib.import_module("Anie.modules." +
                                              module_name)
